...
import {FaArrowCircleLeft, FaStar, FaHeart, FaUserCircle, FaComment, FaPlusCircle} from "react-icons/fa";
...
const Sidebar = () => {
    ...
    return (
        <div className="flex absolute left-0 top-16 h-full">
            <div
                className={` ${open ? "w-96" : "w-0 "} bg-green-700 h-full p-5  pt-8 relative duration-300 right-0`}>
                <FaArrowCircleLeft
                    className={`absolute cursor-pointer -right-1 top-9 w-7  rounded-full text-yellow-500 w-8 h-8  ${!open && "rotate-180"}`}
                    onClick={() => setOpen(!open)}/>
                <div className="flex gap-x-4 items-center">
                    <FaStar
                        className={`text-4xl text-yellow-500 cursor-pointer duration-500 ${open ? "w-16" : "w-20" && "rotate-[360deg]"}`}/>
                    <h1
                            ...
                            <div
                                ...
                                <div className=" flex-row items-start  ">
                                    ...
                                    < div className="text-black flex justify-between px-4 mt-6">
                                        <h2>Bekbolotova K</h2>
                                        <h1 className="flex items-center"><FaHeart
                                            className="mx-1 text-red-600 text-x"/>13K</h1>
                                    </div>
                                </div>
                                ...
                                <div className="like border-t-2 flex justify-around mt-2 py-2 text-center">
                                    ...
                                    <BsFillHandThumbsUpFill
                                        className="text-gray-400 text-3xl w-1/3 border-r-2 text-center "/>
                                    <BsHandThumbsDownFill
                                        className="text-gray-400 text-3xl border-r-2 w-1/3  text-center"/>
